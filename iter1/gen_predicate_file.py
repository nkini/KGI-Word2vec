...
def preproc_for_avg_rel_vec(eer_filelist,w2v_vocab_file,nid2mid_file):
    '''
    ...
    for file in eer_filelist:
        ...
        with open(file) as f:
            ...
            for line in f:
                ...
                if truth == '1' and e1 in n2m and e2 in n2m and n2m[e1] in vocab and n2m[e2] in vocab:
